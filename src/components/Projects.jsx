...
const Projects = () => {
    ...
    return (
        <div className="project-container flex flex-col items-center justify-center p-20 bg-[#0a0f1a] relative">
            ...
            <h1 data-aos="fade-up" className="mb-10 mt-10 p-2 text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-500">
                My Projects
            </h1>

            {/* This is a First Project */}
            <div data-aos="zoom-in" className="flex flex-col md:flex-row items-center mt-20 text-center md:text-left gap-20">
                <img
                    src="AI.jpg"
            ...
            <div data-aos="zoom-in" className="flex flex-col md:flex-row items-center mt-20 text-center md:text-left gap-10 mb-10">
